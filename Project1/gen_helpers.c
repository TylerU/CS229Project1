...
const char* error_descriptions[] = {"UNEXPECTED_EOF or Input Error","GOOD","UNRECOGNIZED_FILE_FORMAT","WRONG_NUMBER_OF_SOUND_READINGS","NOT_ENOUGH_SAMPLES",
	...
	"Unable to concatenate the given files. Ensure that the files have the same number of channels, sample rate, and bit depth", "Invalid block size specified", "Invalid program state encountered. You have completed some series of commands I didn't see coming or that weren't mean to be completed"};
